...
<div id="loading-screen">
    <div class="spinner">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/images/logo_passionbeaute.png" class="logo" alt="Loading">
    </div>
</div>
<div class="d-flex">
    <!-- Sidebar -->
    <aside id="sidebar" class="bg-light border-right">
        <div class="sidebar-header text-center">
            <img src="<?php echo get_template_directory_uri(); ?>/images/logo_passionbeaute.png" class="logo" alt="Passion Beauté"
                 width="150">
        </div>
